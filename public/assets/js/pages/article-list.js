    ...
    articleData.data.reverse().forEach((element) => {
        ...
        html += `<span class="inline-flex items-center text-xs text-[#666]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
                        <path d="M3 14s-1 0-1-1 1-1 1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm7-6a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm-3 6a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm-7 0a3 3 0 1 1 0-6 3 3 0 0 1 0 6zm-3 6a3 3 0 1 1 0-6 3 3 0 0 1 0 6z"/>
                    </svg>
