        ...
        data.data.forEach((value, i) => {
            let html = `<tr>
                ...
                <td class="py-4">
                    ...
                    <img src="${baseL}/${value.location}" alt="${value.description}" class="max-w-full max-h-full p-2  bg-cover object-cover bg-center cursor-pointer" onclick="myModal${i}.showModal()">
