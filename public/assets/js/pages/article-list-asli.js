        ...
        data.data.reverse().forEach((element) => {
            ...
            html += `
                <div class="mb-8 md:col-6 lg:col-4">
                    <div class="card min-h-[1000px] max-h-[1000px]" >
                    <div class="card-content flex flex-col justify-between h-full">
                    <div class="">
                            <img class="card-img h-28 w-full object-cover" src="${baseL}/${element.image}" alt="" />
                            <div class="card-tags">
                                <a class="tag" href="#">${
                            ...
                            <h3 class="h4 card-title mt-3">
                                <a href="${baseL}/article/${element.id}" class="pt-10">
                                    ${element.title}
                                </a>
                            </h3>
                            <p>${content}...</p>
                            </div>
                            <div class="card-footer mt-6 flex items-end space-x-4">
