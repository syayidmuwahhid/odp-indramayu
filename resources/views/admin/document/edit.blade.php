...
<div class="w-full px-6 py-6 mx-auto">
    <form action="/api/document/{{ $id }}" class="h-full flex flex-col" method="post" id="form_submit" enctype="multipart/form-data">
            ...
            <div class="grid grid-row mb-6 min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-3 mb-6 mt-5" id="upload-container">
                        ...
                        <div class="col-span-2 align-middle">
                            <input type="file" name="file" id="file" class="inputan" placeholder="Upload File" accept=".pdf">
                        </div>
                    </div>
...
@push('js')
    ...
    <script src="{{ asset('assets/js/pages/document-edit.js') }}"></script>
@endpush
