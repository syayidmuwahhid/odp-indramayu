    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{ url('') }}">
            <img src="{{ asset('assets/img/favicon.png') }}"
                class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" id="appLogo"/>
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand" id="appName">ODP Indramayu</span>
        </a>
    </div>
                    ...
                    <div class="{{ url()->current() == route('admin.dashboard') ? $i_active : '' }}shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            ...
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                <g transform="translate(-1716.000000, -439.000000)" fill="#6F747F" fill-rule="nonzero">
