<aside
    class="max-w-62.5 ease-nav-brand fixed inset-y-0 my-4 ml-4 block w-full small-left-minus flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
    <div class="h-19.5">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            {{-- MENU --}}
            <li class="mt-0.5 w-full">
                <a class="{{ url()->current() == route('admin.menu.index') ? $a_active : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="{{ route('admin.menu.index') }}">
                    <div class="{{ url()->current() == route('admin.menu.index') ? $i_active : '' }}shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
