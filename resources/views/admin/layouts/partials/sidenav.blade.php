<aside
    ...
    <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{ url('') }}">
            <img src=""
                class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8 appLogo" alt="main_logo" />
            <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand appName">ODP Indramayu</span>
        </a>
    </div>
