          ...
          <div class="flex-auto px-0 pt-0 pb-2">
            <div class="px-10 overflow-x-auto" id="table_container">
                ...
                <thead class="align-bottom">
                  <tr>
                    <th class="text-center px-6 py-3 font-bold uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                      No
                    </th>
                    <th class="px-6 py-3 pl-6 font-bold text-left uppercase align-middle bg-transparent border-b border-gray-200 shadow-none text-xxs border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                      Thumbnail
                    </th>
...
<script src="{{ asset('assets/js/pages/video-index.js') }}"></script>
@endpush
