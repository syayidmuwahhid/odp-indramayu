<footer class="footer bg-theme-light/50">
    <div class="container">
      <div class="row gx-5 pb-10 pt-[52px]">
        <div class="col-12 mt-12 md:col-6 lg:col-6">
            ...
            <p class="mt-6 appDescription"></p>
        </div>
        <div class="col-12 mt-12 md:col-6 lg:col-6">
          <h6>Socials</h6>
          <ul class="social-icons mt-4 lg:mt-6">
            <li>
              <a href="#" id="appFacebook" target="_blank">
            ...
            <li>
              <a href="#" id="appYoutube" target="_blank">
            ...
            <li>
              <a href="#" id="appInstagram" target="_blank">
